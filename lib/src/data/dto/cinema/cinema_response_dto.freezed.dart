...
mixin _$CinemaResponseDto {
 ...
 int get id; String get name; String get city; String get address; double get rating; double get lat; double get lon;@JsonKey(name: 'picture_url') String get pictureUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,city,address,rating,lat,lon,pictureUrl);

@override
String toString() {
  return 'CinemaResponseDto(id: $id, name: $name, city: $city, address: $address, rating: $rating, lat: $lat, lon: $lon, pictureUrl: $pictureUrl)';
}
...
@useResult
$Res call({
 int id, String name, String city, String address, double rating, double lat, double lon,@JsonKey(name: 'picture_url') String pictureUrl
});
...
/// Create a copy of CinemaResponseDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? city = null,Object? address = null,Object? rating = null,Object? lat = null,Object? lon = null,Object? pictureUrl = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String city,  String address,  double rating,  double lat,  double lon, @JsonKey(name: 'picture_url')  String pictureUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CinemaResponseDto() when $default != null:
return $default(_that.id,_that.name,_that.city,_that.address,_that.rating,_that.lat,_that.lon,_that.pictureUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String city,  String address,  double rating,  double lat,  double lon, @JsonKey(name: 'picture_url')  String pictureUrl)  $default,) {final _that = this;
switch (_that) {
case _CinemaResponseDto():
return $default(_that.id,_that.name,_that.city,_that.address,_that.rating,_that.lat,_that.lon,_that.pictureUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String city,  String address,  double rating,  double lat,  double lon, @JsonKey(name: 'picture_url')  String pictureUrl)?  $default,) {final _that = this;
switch (_that) {
case _CinemaResponseDto() when $default != null:
return $default(_that.id,_that.name,_that.city,_that.address,_that.rating,_that.lat,_that.lon,_that.pictureUrl);case _:
  return null;
...
class _CinemaResponseDto implements CinemaResponseDto {
  const _CinemaResponseDto({this.id = 0, this.name = '', this.city = '', this.address = '', this.rating = 0.0, this.lat = 0.0, this.lon = 0.0, @JsonKey(name: 'picture_url') this.pictureUrl = ''});
...
/// Create a copy of CinemaResponseDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? city = null,Object? address = null,Object? rating = null,Object? lat = null,Object? lon = null,Object? pictureUrl = null,}) {
