...
@override
String toString() {
  return 'Cinema(id: $id, name: $name, city: $city, address: $address, rating: $rating, lat: $lat, lon: $lon, pictureUrl: $pictureUrl)';
}
...
class _Cinema implements Cinema {
  const _Cinema({this.id = 0, this.name = '', this.city = '', this.address = '', this.rating = 0.0, this.lat = 0.0, this.lon = 0.0, @JsonKey(name: 'picture_url') this.pictureUrl = ''});
